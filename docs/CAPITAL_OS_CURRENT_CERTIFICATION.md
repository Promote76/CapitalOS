...
| Clerk reverification      | BLOCKED         | Provider-supported strict reverification implementation exists in the Clerk client and API middleware                                                                                                                                                                                   | Reverification unit tests and provider route wiring passed; no real Clerk challenge, successful retry, failed/cancelled challenge, bounded expiry, or authenticated audit/telemetry evidence has been completed | **BLOCKED** | `docs/certification/AUTHENTICATED_BROWSER_CERTIFICATION_2026-09-05.md`; `artifacts/api-server/src/middleware/reverification.test.ts` |
