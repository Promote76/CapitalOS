...
<!-- tenant-route-inventory: 243 -->
**Inventory result:** 243 Express route/method pairs match the executable route inventory.
...
The full 243-route preflight target is defined below. The latest clean guarded
