...
| GET /family-office; GET /family-office/real-estate; POST /family-office/research; POST /family-office/proposals/:proposalId/decision; POST /family-office/shadow/portfolios; POST /family-office/shadow/intents; POST /family-office/tax-liens | proposalId, shadowPortfolioId, householdId mass-assignment field, research/provider body | Request-scoped household predicates; role and recent-auth middleware; provider fail-closed handling; Shadow-only persistence | PASS | PASS | PASS | PASS |
