...
<!-- tenant-route-inventory: 192 -->
**Inventory result:** 192 Express route/method pairs match the executable route inventory.
...
The full 192-route preflight target is defined below. The latest clean guarded
