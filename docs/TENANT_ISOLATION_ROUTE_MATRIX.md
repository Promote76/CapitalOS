...
<!-- tenant-route-inventory: 174 -->
**Inventory result:** 174 Express route/method pairs match the executable route inventory.
...
The full 174-route preflight target is defined below. The latest clean guarded
