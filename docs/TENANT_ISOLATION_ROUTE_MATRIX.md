...
<!-- tenant-route-inventory: 218 -->
**Inventory result:** 218 Express route/method pairs match the executable route inventory.
...
The full 218-route preflight target is defined below. The latest clean guarded
