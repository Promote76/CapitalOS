 ...
 */
export const retryBankStatementParserPathDocumentIdRegExp = new RegExp('^[0-9a-fA-F-]{36}$');


export const RetryBankStatementParserParams = zod.object({
  "documentId": zod.coerce.string().regex(retryBankStatementParserPathDocumentIdRegExp)
})

export const retryBankStatementParserBodyReasonMax = 1000;

export const retryBankStatementParserBodyIdempotencyKeyMin = 8;
export const retryBankStatementParserBodyIdempotencyKeyMax = 128;



export const RetryBankStatementParserBody = zod.object({
  "reason": zod.string().min(1).max(retryBankStatementParserBodyReasonMax),
  "idempotencyKey": zod.string().min(retryBankStatementParserBodyIdempotencyKeyMin).max(retryBankStatementParserBodyIdempotencyKeyMax)
})

export const retryBankStatementParserResponseTransactionsItemSourcePageMultipleOf = 1;

export const retryBankStatementParserResponseTransactionsItemSourceLineMultipleOf = 1;

export const retryBankStatementParserResponseTransactionsItemCategoryCorrectionVersionMin = 0;
export const retryBankStatementParserResponseTransactionsItemCategoryCorrectionVersionMultipleOf = 1;

export const retryBankStatementParserResponseTransactionsItemCorrectionHistoryItemRevisionMultipleOf = 1;



export const RetryBankStatementParserResponse = zod.object({
  "id": zod.string(),
  "businessId": zod.string().nullable(),
  "documentType": zod.string(),
  "originalDocumentType": zod.string().nullish(),
  ...
  "reference": zod.string().nullish(),
  "confidence": zod.string().nullable(),
  "sourcePage": zod.number().multipleOf(retryBankStatementParserResponseTransactionsItemSourcePageMultipleOf).nullish(),
  "sourceLine": zod.number().multipleOf(retryBankStatementParserResponseTransactionsItemSourceLineMultipleOf).nullable(),
  "sourceRegion": zod.string().nullable(),
  "parserVersion": zod.string(),
  "evidenceFingerprint": zod.string(),
  "reviewStatus": zod.string(),
  ...
  "categoryDecidedBy": zod.string().nullish(),
  "categoryDecidedAt": zod.coerce.date().nullish(),
  "categoryCorrectionVersion": zod.number().min(retryBankStatementParserResponseTransactionsItemCategoryCorrectionVersionMin).multipleOf(retryBankStatementParserResponseTransactionsItemCategoryCorrectionVersionMultipleOf).optional(),
  "economicClassification": zod.enum(['HOUSEHOLD', 'BUSINESS', 'TRANSFER', 'SETTLEMENT_LINK', 'UNKNOWN']).optional(),
  "createdAt": zod.coerce.date(),
  "correctionHistory": zod.array(zod.object({
  "id": zod.string(),
  "transactionId": zod.string(),
  "revision": zod.number().multipleOf(retryBankStatementParserResponseTransactionsItemCorrectionHistoryItemRevisionMultipleOf),
  "previousValue": zod.record(zod.string(), zod.unknown()).nullish(),
  "correctedValue": zod.record(zod.string(), zod.unknown()),
  "reason": zod.string(),
  "correctedAt": zod.coerce.date()
