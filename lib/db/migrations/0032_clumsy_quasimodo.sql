...
CREATE INDEX "bank_statement_transaction_corrections_household_transaction_idx" ON "bank_statement_transaction_corrections" USING btree ("household_id","transaction_id");