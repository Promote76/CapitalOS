...
export const householdVehicleScenarios = pgTable(
  "household_vehicle_scenarios",
  {
    ...
    newOperatingCost: money("new_operating_cost"),
    cashBufferImpact: money("cash_buffer_impact"),
    emergencyReserveImpact: money("emergency_reserve_impact"),
    duplexContributionImpact: money("duplex_contribution_impact"),
